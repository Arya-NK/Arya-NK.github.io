...
<figure>
    ...
    <figcaption>The blind men and the giant elephant: the localized (limited) view of each blind man leads to a biased conclusion.</figcaption>
</figure>
...
![]({{site.url}}/assets/img/postimages/Venn_diagram.png)[Data Science - Venn diagram]
...
![({{site.url}}/assets/img/postimages/DS_LifeCycle.png)][Data science lifecycle]
...
![]({{site.url}}/assets/img/postimages/KDD_Process.jpg)[KDD Process]
